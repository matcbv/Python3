...
# A classe Random possui diversos métodos para nos auxiliar na utilização de números pseudoaleatórios.
rand = Random()
# OBS.: PODEMOS UTILIZAR TAIS MÉTODOS DIRETAMENTE DO MÓDULO RANDOM!

# Com o método randint definimos um número inteiro aleatório passando um começo e fim para as escolhas:
print('randint:', rand.randint(1, 10))
print()
...
print('randrange:', rand.randrange(0, 10, 2))
print()
...
nova_lista = rand.sample(lista_nomes, k=3)
...
nova_lista_com_repeticao = rand.choices(lista_nomes, k=2)
