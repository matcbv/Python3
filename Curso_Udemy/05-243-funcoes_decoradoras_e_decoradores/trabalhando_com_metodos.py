...
# A função mostra_time retorna a função interna, logo, ao nos referirmos a nome_time,
# a função interna será chamada.

# Ao passarmos nossa instância por parâmetro, interna o receberá em seu parâmetro valor.

# A função interna retornará o objeto resultado, cujo valor será o retorno de metodo,
# recebendo o parâmetro valor proveniente da função interna. metodo é a função nome_time
...
print(time01.nome_time())
print(time02.nome_time())
